...
public class UserServiceCreateUserTest {
    ...
    @Test
    void testValidUserIsSaved() throws InvalidDateException, RequiredFieldException, InvalidEmailException, DuplicateEmailException {
    ...
    @Test
    void returnRequiredFieldExceptionWhenLastNameEmpty() {
